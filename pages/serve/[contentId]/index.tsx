...
const ServeContent = () => {
    ...
    const renderedContent = useCallback(() => {
        ...
        } else if (content && (content.fileType === 'link' || content.fileType === 'unknown')) {
            return (
                <a
    ...
    return (
        <>
            ...
            //! DO NOT CHECK FOR EACH ERROR MESSAGE.
            //! THAT IS WHY YOU ARE USING A DYNAMIC errorMessage, SO YOU CAN SHOW IT DIRECTLY NO MATTER WHAT IT IS.
            ...
            {address && content && errorMessage === 'Does not have access' && (
                ...
                >
                    <h2 style={{ color: '#0091ff' }}>You do not have access to this content</h2>
                </div>
            )}
            //! DO NOT CHECK FOR EACH ERROR MESSAGE.
            //! THAT IS WHY YOU ARE USING A DYNAMIC errorMessage, SO YOU CAN SHOW IT DIRECTLY NO MATTER WHAT IT IS.
