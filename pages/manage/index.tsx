...
const Manage = () => {
  ...
  return (
    <Layout>
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, margin: 'auto', maxWidth: '50%', marginTop: 10 }}>
      <Box sx={{ p: 2, border: '1px solid #ccc', }}>
        {/* Content for the first box */}
        <Typography level="h6" sx={{ marginBottom: 2 }}>Email Address: test@test.com</Typography>
        <Input
