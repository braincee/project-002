...
const ContentList = ({
    ...
    useEffect(() => {
     ...
     //! Change this any type, event should have types by default
    ...
    const emptyRows = page > 0 ? Math.max(0, (1 + page) * rowsPerPage - contentList.length) : 0
    ...
    return (
        <Box sx={{ px: { md: 4 }, display: 'flex', flexDirection: 'column', gap: 2 }}>
            <Stack spacing={1}>
                <Sheet
                    variant='outlined'
                    sx={{
              ...
              radial-gradient(
                ...
                <Modal open={deleteOpen} onClose={() => setDeleteOpen(false)}>
                    ...
                    >
                        {' '}
                        <Typography id='nested-modal-title' level='h2' sx={{ mb: { xs: 2 } }}>
                        ...
                        >
                            ...
                            <Radio value='false' label='Delete' variant='outlined' size='lg' />
                        </RadioGroup>
                    </ModalDialog>
                </Modal>
            </Stack>
